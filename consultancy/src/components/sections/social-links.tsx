    ...
    <div className="flex h-16 items-center justify-center gap-4">
      {connects.map((connect, index) => (
        <motion.a
          ...
          className="group relative flex items-center justify-center rounded-full p-1 transition-colors text-white bg-gray-100"
          ...
          <motion.span
            className="absolute -inset-2 -z-10 rounded-full bg-gradient-to-r from-primary/20 to-primary/10 opacity-0 blur transition-opacity duration-300 group-hover:opacity-100"
            initial={false}
            whileHover={{ scale: 1.2 }}
          />
          <span className=" text-primary transition-colors duration-200 group-hover:text-primary ">{connect.icons}</span>
